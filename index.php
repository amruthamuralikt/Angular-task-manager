...
<div style=" margin-left:120px;">
  <form class="form-inline" >
    <input class="form-control mr-sm-2" type="search" placeholder="Filter Tasks" aria-label="Search">
   </form>
</div>
  ...
  <input type="text" class="form-control" name="addItem" placeholder="" aria-label="Recipient's username" aria-describedby="basic-addon2" ng-model="addItem">
  <div class="input-group-append">
    <button  class="btn btn-outline-secondary" type="button" ng-click="pushItem()"><i class="fa fa-plus" ></i>Add New Task</button>
        ...
        <ul>
            ...
            <span class="done-{{i.status}} sp">   
              <input type="checkbox"  ng-model="i.status">
            {{i.taskMessage}} 
</span>
                <span class="fa fa-trash fa-xs spa" ng-click="delete($index)"></span>
            </li> 
        </ul>
    </div>
    </div>
